...
public:
	...
	void play_stand_alone();
	// Primary game driver(stand alone version), loops through turn-by-turn until there's
	// a winner or full game board (draw)

	void play_network();
	// Primary game driver(network version), loops through turn-by-turn until there's
	// a winner or full game board (draw)
